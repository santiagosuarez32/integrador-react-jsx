...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full bg-transparent backdrop-blur-sm text-white flex items-center justify-between px-6 py-4 z-50">
      ...
      <div className="text-xl font-bold">MaxShoes</div>
      ...
      <div className={`absolute top-16 left-0 w-full bg-white bg-opacity-10 backdrop-blur-sm transition-transform duration-300 ease-in-out ${menuOpen ? "translate-y-0" : "-translate-y-full"} md:relative md:top-auto md:w-auto md:bg-transparent md:translate-y-0 md:flex md:justify-center`}>
        <ul className="flex flex-col md:flex-row md:space-x-6 text-center lg:translate-x-[-30px] md:translate-x-0 md:translate-y-0 ">
          <li><a href="#" className="block py-2 hover:text-gray-400">Inicio</a></li>
          <li><a href="#" className="block py-2 hover:text-gray-400">Productos</a></li>
          <li><a href="#" className="block py-2 hover:text-gray-400">Nosotros</a></li>
          <li><a href="#" className="block py-2 hover:text-gray-400">Contacto</a></li>
        </ul>
      </div>
