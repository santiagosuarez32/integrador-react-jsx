...
const AboutUs = () => {
  return (
    <div className="about-us-container bg-gray-400 p-10  shadow-lg  h-[80vh] flex flex-col md:flex-row items-center justify-center " style={{ fontFamily: "'Poppins', sans-serif" }}>

      {/* Sección de texto a la izquierda */}
      <div className="max-w-md">
        <h2 className="text-4xl font-bold text-gray-900" style={{ fontFamily: "'Poppins', sans-serif" }}>¿Quienes Somos?</h2>
      ...
      <img src="/img/logo.PNG" alt="Logo" className="w-auto max-h-45 lg:max-h-80" />
